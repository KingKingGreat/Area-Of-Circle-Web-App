...
function onButtonClick() {
	...
	if (!value) {
		...
		if (type === "rad") {
			// Radius
			document.getElementById("rText").innerHTML = "Question : " + value + " Radius" + " = ? Area" + "<br>";  
		    result = Math.PI * (value * value);
		} else {
			// Diameter
			document.getElementById("rText").innerHTML = "Question : " + value + " Diameter" + " = ? Area" + "<br>"; 
		    result = Math.PI * ((value / 2) * (value / 2));
		}
		// Display Result
